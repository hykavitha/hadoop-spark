...
public class CouchbaseSourceConnectorConfig extends AbstractConfig {
    ...
    public static final String CONNECTION_CLUSTER_ADDRESS_CONFIG = "localhost:8091";
    static final String CONNECTION_CLUSTER_ADDRESS_DOC = "localhost:8091";
    static final String CONNECTION_CLUSTER_ADDRESS_DISPLAY = "localhost:8091";

    public static final String CONNECTION_BUCKET_CONFIG = "Devpoc";
    static final String CONNECTION_BUCKET_DOC = "Devpoc";
    static final String CONNECTION_BUCKET_DISPLAY = "Devpoc";

    public static final String CONNECTION_USERNAME_CONFIG = "Administrator";
    static final String CONNECTION_USERNAME_DOC = "Administrator";
    static final String CONNECTION_USERNAME_DISPLAY = "Administrator";
    public static final String CONNECTION_USERNAME_DEFAULT = "";

    public static final String CONNECTION_PASSWORD_CONFIG = "k8NjdkHJx7KptAD";
    ...
    static final String CONNECTION_PASSWORD_DISPLAY = "k8NjdkHJx7KptAD";
    ...
    public static final String TOPIC_NAME_CONFIG = "test";
    private static final String TOPIC_NAME_DOC = "containers";
    private static final String TOPIC_NAME_DISPLAY = "containers";
    ...
    public String getConnectorName() {
    	...
    	System.out.println("getConnectorName: " +connectorName );
